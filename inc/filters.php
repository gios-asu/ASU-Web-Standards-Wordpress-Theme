...
function asu_ws_search_form () {
  $form = '<form target="_top" action="https://search.asu.edu/search" method="get" name="gs">
            ...
            <input value="' . get_search_query() . '" type="text" name="q" size="32" placeholder="Search ASU" id="asu_search_box" class="asu_search_box" onfocus="ASUHeader.searchFocus(this)" onblur="ASUHeader.searchBlur(this)"> 
